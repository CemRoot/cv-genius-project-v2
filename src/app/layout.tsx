  ...
  return (
    <html lang="en-IE" className="scroll-smooth h-full" suppressHydrationWarning>
      <head>
        ...
        {/* Monetag Advertising - Multiple Zones for Maximum Revenue */}
        <script src="https://fpyf8.com/88/tag.min.js" data-zone="153060" async data-cfasync="false"></script>
        <script src="https://fpyf8.com/88/tag.min.js" data-zone="9469382" async data-cfasync="false"></script>
        <script src="https://fpyf8.com/88/tag.min.js" data-zone="9469381" async data-cfasync="false"></script>
        <script src="https://fpyf8.com/88/tag.min.js" data-zone="9469380" async data-cfasync="false"></script>
        <script src="https://fpyf8.com/88/tag.min.js" data-zone="9469379" async data-cfasync="false"></script>
